...
async def get_messages(chat_id: int, client: Annotated[message_pb2_grpc.MessageServiceStub, Depends(grpc_message_client)], current_user: Annotated[SUser, Depends(get_current_user)]):
